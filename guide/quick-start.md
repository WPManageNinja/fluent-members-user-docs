...
1. In your WordPress sidebar, open **Fluent Members → Access Groups**.
   *You'll see an empty list on a fresh install. That's expected.*
2. Click **Add New Group**.
   *A creation panel opens on the right side of the screen.*
3. Fill in:
...
3. Find the **Content Restriction Rules** section and click **Add Rule**.
